...
def main(argv):
    ...
    if 'DEV' in argv:
        transfers_file = os.getenv(
            "DEV_XCM_JSON_PATH", "xcm/v5/transfers_dev.json")
        chains_url = nova_utils_url + \
            os.getenv("DEV_CHAINS_JSON_PATH", "chains/v16/chains_dev.json")
    elif 'PROD' in argv:
        transfers_file = os.getenv("XCM_JSON_PATH", "xcm/v5/transfers.json")
        chains_url = nova_utils_url + \
            os.getenv("CHAINS_JSON_PATH", "chains/v16/chains.json")
    else:
        raise Exception(
